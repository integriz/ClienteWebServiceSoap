    ...
    extends Service
{
    ...
    static {
        ...
        WEBSERVICESOAPENVIARECEBEARQUIVOSERVICE_WSDL_LOCATION = url;
        WEBSERVICESOAPENVIARECEBEARQUIVOSERVICE_EXCEPTION = e;
    }

    public WebServiceSOAPEnviaRecebeArquivoService() {
        super(__getWsdlLocation(), WEBSERVICESOAPENVIARECEBEARQUIVOSERVICE_QNAME);
    }

    public WebServiceSOAPEnviaRecebeArquivoService(WebServiceFeature... features) {
        super(__getWsdlLocation(), WEBSERVICESOAPENVIARECEBEARQUIVOSERVICE_QNAME, features);
    }

    public WebServiceSOAPEnviaRecebeArquivoService(URL wsdlLocation) {
        super(wsdlLocation, WEBSERVICESOAPENVIARECEBEARQUIVOSERVICE_QNAME);
    }

    public WebServiceSOAPEnviaRecebeArquivoService(URL wsdlLocation, WebServiceFeature... features) {
        super(wsdlLocation, WEBSERVICESOAPENVIARECEBEARQUIVOSERVICE_QNAME, features);
    }

    public WebServiceSOAPEnviaRecebeArquivoService(URL wsdlLocation, QName serviceName) {
        super(wsdlLocation, serviceName);
    }

    public WebServiceSOAPEnviaRecebeArquivoService(URL wsdlLocation, QName serviceName, WebServiceFeature... features) {
     ...
     * 
     * @return
     *     returns WebServiceSOAPEnviaRecebeArquivo
     */
    ...
    private static URL __getWsdlLocation() {
        if (WEBSERVICESOAPENVIARECEBEARQUIVOSERVICE_EXCEPTION!= null) {
            throw WEBSERVICESOAPENVIARECEBEARQUIVOSERVICE_EXCEPTION;
        }
        return WEBSERVICESOAPENVIARECEBEARQUIVOSERVICE_WSDL_LOCATION;
    }
